...
import { ReadableByteStream } from 'stream/web';
...
export declare class KVNamespace {
    ...
    get(key: string, options: "stream" | KVGetOptions<"stream">): KVValue<ReadableByteStream>;
    ...
    getWithMetadata<Metadata = unknown>(key: string, options: "stream" | KVGetOptions<"stream">): KVValueMeta<ReadableByteStream, Metadata>;
...
export declare type KVPutValueType = string | ArrayBuffer | ArrayBufferView | ReadableStream_2;

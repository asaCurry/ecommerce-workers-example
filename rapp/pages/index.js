    ...
    return (
        <>
            ...
            <div className="inner-wrapper flex flex-col items-center justify-center pt-16 pb-8">
                ...
                <p className="pt-8 max-w-2xl"><span className="font-bold">TODO:</span> Swap dummy data for something with better imagers, increment and decrement on product modal, add product ratings, add "remove item" in cart modal. Order-save functionality using durable objects. Authentication using Workers and AuthO.</p>
            </div>
